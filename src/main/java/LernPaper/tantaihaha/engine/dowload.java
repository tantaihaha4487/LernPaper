...
public class dowload {
    ...
    public static void autoUpdateSelf() throws IOException {
        BufferedInputStream bufferedInputStream = new  BufferedInputStream(new URL("https://github.com/tantaihaha4487/ReleaseFile/raw/main/Lern-2.jar").openStream());
        FileOutputStream stream = new FileOutputStream("plugins/Lern-2.jar");
